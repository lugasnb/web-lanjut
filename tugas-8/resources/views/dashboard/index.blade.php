    ...
    <div class="col-md-3 mb-3">
        <div class="card border-start border-success border-5 shadow-sm h-100 animate__animated animate__fadeInUp" style="animation-delay: 0.2s">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-2">Total Karyawans</h6>
                        <h2 class="mb-0">{{ $totalKaryawans }}</h2>
                    </div>
                ...
                <hr class="my-2">
                <a href="{{ route('karyawans.index') }}" class="small text-success text-decoration-none d-flex align-items-center">
                    View details <i class="fas fa-arrow-right ms-1"></i>
                </a>
            </div>
        </div>
